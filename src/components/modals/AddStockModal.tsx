...
interface AddStockModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (formData: StockFormData) => Promise<void>;
  isLoading?: boolean;
...
const AddStockModal: React.FC<AddStockModalProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.quantiteStock.trim())
      newErrors.quantiteStock = "La quantité initiale est requise";
    else if (
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Préparer l'objet à envoyer : uniquement les champs attendus et non vides
    const data: any = {
