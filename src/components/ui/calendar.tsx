  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "bg-orange-100 text-orange-900 rounded-l-md",
          defaultClassNames.range_start
        ),
        range_middle: cn(
          "rounded-none bg-orange-50 text-orange-900",
          defaultClassNames.range_middle
        ),
        range_end: cn(
          "bg-orange-100 text-orange-900 rounded-r-md",
          defaultClassNames.range_end
        ),
        today: cn(
          "bg-orange-50 text-orange-900 rounded-md data-[selected=true]:rounded-none border border-orange-200",
