...
import { User, ListBullets, Users } from "@phosphor-icons/react";
    ...
    <header className="flex flex-col w-full items-start">
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="relative w-10 h-10 cursor-pointer bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition-colors">
                  <User size={20} className="text-gray-600" />
                  <div className="absolute w-3 h-3 bottom-0 right-0 bg-success-50 rounded-full border border-white" />
                </div>
              </DropdownMenuTrigger>
      ...
      <div className="hidden lg:flex items-center justify-between px-3 md:px-6 lg:px-12 xl:px-20 py-6 w-full bg-white border-b border-slate-200">
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <div className="relative w-12 h-12 cursor-pointer bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition-colors">
